...
<div class="breadcrumb breadcrumb_alt p-5">
    <div class="mt-5">
        ...
        <a href="#">
            <div class="card border border-divider px-4 py-8 text-center lg:transform hover:scale-110 hover:shadow-lg transition-transform duration-200">
                <span class="text-primary text-5xl leading-none la la-folder-plus"></span>
                <h5 class="text-primary leading-none mt-5">Support du Cours</h5>
        ...
        <a href="#">
            <div class="card border border-divider px-4 py-8 text-center lg:transform hover:scale-110 hover:shadow-lg transition-transform duration-200">
                ...
                <h5 class="text-primary leading-none mt-5">Unité d'enseignements</h5>
                <p class="mt-2 text-gray-600">Liste par semestre</p>
            </div>
        </a>
        <a href="#">
            <div class="card border border-divider px-4 py-8 text-center lg:transform hover:scale-110 hover:shadow-lg transition-transform duration-200">
                <span class="text-primary text-5xl leading-none la la-list-alt"></span>
                <h5 class="text-primary leading-none mt-5">Matières</h5>
                <p class="mt-2 text-gray-600">Liste par semestre</p>
            </div>
        </a>
