...
@section('title') {{$title. ' ' .$secretaire->fname. ' '.$secretaire->lname}} @stop
@section('content')
<!-- Workspace -->
    <main class="workspace">
        ...
        <section class="breadcrumb">
            ...
            <ul>
                ...
                <li><a href="{{URL::route('secretaire_admin')}}">Sécretaire</a></li>
                <li class="divider la la-arrow-right"></li>
                <li>Modifier</li>
            </ul>
        </section>

        {{ Form::open(['route'=>['updateSecretaire', $secretaire->token], 'files'=>'true', 'class'=>'', 'id'=>'myForm', 'data-toggle'=>'validator'])  }}
                ...
                <div class="card p-5 mt-3">
                    <div class="flex flex-wrap flex-row -mx-4"> 
                        <div class="mb-5 flex-shrink px-4 w-full xl:w-1/2">
                            ...
                            {{ Form::text('fname', $secretaire->fname, ['id'=>'fname', 'class'=>'form-control']) }}
                        ...
                        <div class="mb-5 flex-shrink px-4 w-full xl:w-1/2">
                            ...
                            {{ Form::text('lname', $secretaire->lname, ['id'=>'lname', 'class'=>'form-control']) }}
                             <div class="help-block with-errors"></div>
