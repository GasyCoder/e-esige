(() => {
	...
	function St(e) {
		v = e.reactive, V = e.release, C = t => e.effect(t, {
			scheduler: r => {
				ze ? wt(r) : r()
			}
		}), Ke = e.raw
	...
	function Br() {
		Z = Z.concat(qe.takeRecords()), Z.length && !Ge && (Ge = !0, queueMicrotask(() => {
			qr(), Ge = !1
		}))
	}
	...
	function me(e, t = () => {}) {
		let r = {
			...
			_x_interceptor: !0,
			initialize(n, i, o) {
				return e(this.initialValue, () => Ur(n, i), s => Ze(n, i, s), i, o)
			}
		};
		return t(r), n => {
	...
	function ee(e, t) {
		return Object.entries(Lt).forEach(([r, n]) => {
	...
	function Gr(e, t) {
		...
		return (n = () => {}, {
			...
			let s = X([i, ...e]),
				a = r(r, s);
			r.finished ? he(n, r.result, s, o) : a.then(c => {
				he(n, c, s, o)
			})
		}
	}
...
`, e), i
	...
	function te(e, t, r) {
		let n = {};
		return Array.from(t).map(zt((o, s) => n[o] = s)).filter(Vt).map(Qr(n, r)).sort(Xr).map(o => Zr(e, o))
	}

	function Bt(e) {
		return Array.from(e).map(zt()).filter(t => !Vt(t))
	}
	var tt = !1,
		re = new Map,
		Ht = Symbol();
	...
	function Zr(e, t) {
		...
		kt(e, t.original, l);
		let u = () => {
			e._x_ignore || e._x_ignoreSelf || (n.inline && n.inline(e, t, c), n = n.bind(n, e, t, c), tt ? re.get(Ht).push(n) : n())
		};
	...
	var rt = "DEFAULT",
		ye = ["ignore", "ref", "data", "bind", "init", "for", "model", "transition", "show", "if", rt, "element"];
	...
	function Jt() {
		document.body || be("Unable to initialize. Trying to load Alpine before `<body>` is available. Did you forget to add `defer` in Alpine's `<script>` tag?"), $(document, "alpine:init"), $(document, "alpine:initializing"), We(), Ct(t => O(t, N)), Mt(t => q(() => en(t))), Nt((t, r) => {
			te(t, r).forEach(n => n())
		});
	...
	function ne(e, t) {
		return Array.isArray(t) ? tr(e, t.join(" ")) : typeof t == "object" && t !== null ? tn(e, t) : typeof t == "function" ? ne(e, t()) : tr(e, t)
	}
	...
	function cn(e, t) {
		let r, n, i, o = ie(() => {
			m(() => {
				r = !0, n || t.before(), i || (t.end(), xe()), t.after(), e.isConnected && t.cleanup(), delete e._x_transitioning
			})
		});
		e._x_transitioning = {
			beforeCancels: [],
			...
			s === 0 && (s = Number(getComputedStyle(e).animationDuration.replace("s", "")) * 1e3), m(() => {
				...
				r || (m(() => {
					t.end()
				}), xe(), setTimeout(e._x_transitioning.finish, s + a), i = !0)
			})
		})
	}
	...
	function cr(e, t) {
		t._x_dataStack = e._x_dataStack, st = !0, un(() => {
			ln(t)
		}), st = !1
	}
	...
	var Oo = at(dn + ",async,autofocus,autoplay,controls,default,defer,disabled,hidden,loop,open,required,reversed,scoped,seamless,checked,muted,multiple,selected");
	...
	var En = at("__proto__,__v_isRef,__isVue"),
		yr = new Set(Object.getOwnPropertyNames(Symbol).map(e => Symbol[e]).filter(Ae)),
		Sn = Re(),
		An = Re(!1, !0),
		On = Re(!0),
		Tn = Re(!0, !0),
	...
	function Re(e = !1, t = !1) {
		return function(n, i, o) {
			...
			return (Ae(i) ? yr.has(i) : En(i)) || (e || w(n, "get", i), t) ? a : ht(a) ? !s || !Oe(i) ? a.value : a : ae(a) ? e ? vr(a) : Me(a) : a
		}
	}
	var Mn = wr(),
		Nn = wr(!0);
	...
	In.forEach(e => {
		Mr[e] = Le(e, !1, !1), kr[e] = Le(e, !0, !1), Nr[e] = Le(e, !1, !0), Dr[e] = Le(e, !0, !0)
	});

	function $e(e, t) {
		let r = t ? e ? Dr : Nr : e ? kr : Mr;
		return (n, i, o) => i === "__v_isReactive" ? !e : i === "__v_isReadonly" ? e : i === "__v_raw" ? n : Reflect.get(se(r, i) && i in n ? r : n, i, o)
	}
	var Ln = {
			get: $e(!1, !1)
		},
	...
	function le(e, t, r, n = []) {
		switch (e._x_bindings || (e._x_bindings = v({})), e._x_bindings[t] = r, t = n.includes("camel") ? qn(t) : t, t) {
			case "value":
				zn(e, r);
				break;
			case "style":
	...
	function zn(e, t) {
		if (e.type === "radio") e.attributes.value === void 0 && (e.value = t), window.fromModel && (e.checked = Lr(e.value, t));
		else if (e.type === "checkbox") Number.isInteger(t) ? e.value = t : !Number.isInteger(t) && !Array.isArray(t) && typeof t != "boolean" && ![null, void 0].includes(t) ? e.value = String(t) : Array.isArray(t) ? e.checked = t.some(r => Lr(r, e.value)) : e.checked = !!t;
	...
	function Hn(e, t, r) {
		[null, void 0, !1].includes(r) && Yn(t) ? e.removeAttribute(t) : (Gn(t) && (r = t), Wn(e, t, r))
	}
	...
	function ue(e, t, r, n) {
		let i = e,
			...
			s = {},
			a = (c, l) => u => l(c, u);
		if (r.includes("dot") && (t = Jn(t)), r.includes("camel") && (t = Zn(t)), r.includes("passive") && (s.passive = !0), r.includes("capture") && (s.capture = !0), r.includes("window") && (i = window), r.includes("document") && (i = document), r.includes("prevent") && (o = a(o, (c, l) => {
	...
	function Xn(e, t) {
		...
		return r = r.filter(o => !i.includes(o)), !(i.length > 0 && i.filter(s => ((s === "cmd" || s === "super") && (s = "meta"), e[`${s}Key`])).length === i.length && $r(e.key).includes(r[0]))
	}
	...
	p("model", (e, {
		...
		i(() => u()), e._x_forceModelUpdate = () => {
			o(d => {
				d === void 0 && r.match(/\./) && (d = ""), window.fromModel = !0, m(() => le(e, "value", d)), delete window.fromModel
			})
		}, n(() => {
	...
	p("for", (e, {
		...
		e._x_prevKeys = [], e._x_lookup = {}, r(() => si(e, i, o, s)), n(() => {
	...
	function si(e, t, r, n) {
		let i = s => typeof s == "object" && !Array.isArray(s),
			o = e;
		r(s => {
			ci(s) && s >= 0 && (s = Array.from(Array(s).keys(), f => f + 1)), s === void 0 && (s = []);
			let a = e._x_lookup,
				c = e._x_prevKeys,
				l = [],
				u = [];
			...
			for (let f = 0; f < E.length; f++) {
				let [_, y] = E[f], R = a[_], M = a[y], z = document.createElement("div");
				m(() => {
					M.after(z), R.after(M), z.before(R), z.remove()
				}), Je(M, l[u.indexOf(y)])
			}
			for (let f = 0; f < d.length; f++) {
				let [_, y] = d[f], R = _ === "template" ? o : a[_], M = l[y], z = u[y], de = document.importNode(o.content, !0).firstElementChild;
				B(de, v(M), o), m(() => {
					R.after(de), O(de)
				}), typeof z == "object" && be("x-for key cannot be an object, it must be a string or an integer", o), a[z] = de
			}
